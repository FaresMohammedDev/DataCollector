...
btnShowForm.addEventListener('click', () => {
    ...
    // تنسيق الأزرار للمظهر الداكن
    btnShowForm.className = 'bg-blue-600 text-white px-4 py-2 rounded-lg font-medium transition hover:bg-blue-700 shadow-[0_0_10px_rgba(37,99,235,0.3)]';
    btnShowList.className = 'bg-[#1e293b] text-gray-300 px-4 py-2 rounded-lg font-medium transition hover:bg-[#2a364a]';
});
...
btnVerifyPassword.addEventListener('click', checkPassword);
...
function showListSection() {
    ...
    btnShowList.className = 'bg-blue-600 text-white px-4 py-2 rounded-lg font-medium transition hover:bg-blue-700 shadow-[0_0_10px_rgba(37,99,235,0.3)]';
    btnShowForm.className = 'bg-[#1e293b] text-gray-300 px-4 py-2 rounded-lg font-medium transition hover:bg-[#2a364a]';
...
function renderStudents(studentsToRender) {
    ...
    if (studentsToRender.length === 0) {
        tableBody.innerHTML = '<tr><td colspan="4" class="p-8 text-center text-gray-500 font-medium">لا توجد بيانات مطابقة للبحث أو الفلتر</td></tr>';
        return;
    }
